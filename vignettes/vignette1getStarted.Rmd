...
This configuration file points to the second major part of a PEP: the sample annotation CSV file (``r { basename(config(bp)$metadata$sample_table) }``). Here are the contents of that file:
