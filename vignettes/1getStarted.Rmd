...
see [this website](https://pepkit.github.io/docs/simple_example/) for the PEP creation instructions and/or use the example provided with this package as guideline

2. **a function that processes your data**

the function has to take the PEP (in form of [`pepr::Project`](http://code.databio.org/pepr/reference/Project-class.html) object as an argument) like [this one](https://raw.githubusercontent.com/pepkit/example_peps/master/example_BiocProject/parseEncodeRegions.R):
...
See this [vignette](./2advancedFeatures.html) if you want to:
