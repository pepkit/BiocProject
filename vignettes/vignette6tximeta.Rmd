...
First, let's download some data that we'll import with `tximeta` function:
...
```
  ...
  $HOME/Desktop/testing/tximeta_pep/tximportData/salmon_dm/{names}/quant.sf
   bioconductor:
...
```r
tximportDataPath = "tximeta_pep/tximportData"
...
## 1: SRR1197474         A
##                                                                                        files
## 1: /Users/mstolarczyk/Desktop/testing/tximeta_pep/tximportData/salmon_dm/SRR1197474/quant.sf
```
...
##   file:  
## /Users/mstolarczyk/Uczelnia/UVA/code/BiocProject/long_vignettes/tximeta_pep/project_config.yaml
##   samples:  1
```
...
##  pep_version: 2.0.0
##  sample_table: 
## /Users/mstolarczyk/Uczelnia/UVA/code/BiocProject/long_vignettes/tximeta_pep/sample_table.csv
##  sample_modifiers:
##     append:
##         files: FILE_PATH_PLACEHOLDER
##     derive:
...
##         sources:
##             FILE_PATH_PLACEHOLDER: 
## /Users/mstolarczyk/Desktop/testing/tximeta_pep/tximportData/salmon_dm/{names}/quant.sf
##  bioconductor:
##     readFunName: readTximeta
##     readFunPath: 
## /Users/mstolarczyk/Uczelnia/UVA/code/BiocProject/long_vignettes/tximeta_pep/readTximeta.R
##  name: tximeta_pep
```
