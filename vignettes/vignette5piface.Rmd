...
or "project" (for runp),
* `command_template`- A Jinja2 template used to construct a pipeline command 
command to run.
...
The first advantage of pipeline interfce concept is the possibility to declare 
