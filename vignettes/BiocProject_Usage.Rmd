...
```
The workhorse of the `BiocProject` package is the `readBiocData()` function. It creates the `Project` object and uses the user-supplied data processing function to create an object enriched in the metadata from PEP.
