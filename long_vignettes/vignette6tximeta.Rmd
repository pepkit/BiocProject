...
library(pepr)
configFile = "tximeta_pep/project_config.yaml"
...
source("tximeta_pep/readTximeta.R")
...
```{r, eval=TRUE, include=FALSE}
if (file.exists("tximeta_pep")) unlink("tximeta_pep", recursive = TRUE)
if (file.exists(pep_path)) file.remove(pep_path)
if (file.exists("BiocFileCache.sqlite")) file.remove("BiocFileCache.sqlite")
```
